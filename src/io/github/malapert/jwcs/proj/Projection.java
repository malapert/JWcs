 ...
 * 
 * <p>
 * Ref : "Representations of celestial coordinates in FITS", 
...
public abstract class Projection {
     ...
     * @throws io.github.malapert.jwcs.proj.exception.ProjectionException when there is an error while the projection
     */
    ...
    /**
     * Computes the celestial spherical coordinates from the native
     * spherical coordinates.
     * @param phi Native longitude in radians
     * @param theta Native latitude in radians
     * @param alphap Native longitude in radians of the native pole
     * @param deltap Native latitude in radians of the native pole
     * @param phip Native longitude in radians of the celestial pole
     ...
     * @param ra_p Celestial longitude in radians of the native pole
     * @param dec_p Celestial latitude in radians of the native pole
     ...
     */
    public void setPhip(double phip) {
        this.phip = phip;
    }
    ...
    public double[] projectionPlane2wcs(double x, double y) throws ProjectionException {
        ...
        return computeCelestialSpherical(pos[0], pos[1], getCrval1(), getCrval2(), phi_p);
    }
    ...
    public double[] wcs2projectionPlane(double ra, double dec) throws ProjectionException {
        ...
        double phi_p = (getCrval2() >= getTheta0()) ? getPhi0() : LONPOLE_PI + getPhi0();
        double[] nativeSpherical = computeNativeSpherical(Math.toRadians(ra), Math.toRadians(dec), ra_p, dec_p, phi_p);
